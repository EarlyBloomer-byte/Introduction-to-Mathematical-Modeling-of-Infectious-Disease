...
Section 1.4 previews the SEIR model (fully developed in Chapter 5) and the delay-differential /
integro-differential formulations that arise from non-exponential residence-time distributions.
